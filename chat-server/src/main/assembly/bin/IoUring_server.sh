...
#      echo  "java ${JVM}   -jar ${WORK_PATH}/lib/${JAR_NAME}  ${options}  ${MAIN_CLASS}   >> ${LOG} 2>&1 &"
#      nohup  java ${JVM}   -jar ${WORK_PATH}/lib/${JAR_NAME}  ${options}  ${MAIN_CLASS}   >> ${LOG} 2>&1 &
      echo  "java ${JVM}   -jar ${WORK_PATH}/lib/${JAR_NAME}  ${options}  ${MAIN_CLASS}  &"
      nohup  java ${JVM}   -jar ${WORK_PATH}/lib/${JAR_NAME}  ${options}  ${MAIN_CLASS}   &
